...
print("4. Converting back to datetime with unit='ms'...")
ts_datetime = pd.to_datetime(ts_int_sliced, unit='ms')
print("  Datetime success! type:", type(ts_datetime), ts_datetime.dtype)
print("  Min:", ts_datetime.min(), "Max:", ts_datetime.max())
