// chart.js - Renderizador SVG Nativo interactivo con Zoom y Pan para FORTINET TRADING BOT
...
function renderSvgChart() {
    ...
    svgHTML += `<text x="${paddingLeft + 10}" y="${height - paddingBottom - 10}" fill="rgba(255,255,255,0.2)" font-size="20" font-weight="bold">FORTINET TRADING BOT (Velas ${activeInterval})</text>`;
